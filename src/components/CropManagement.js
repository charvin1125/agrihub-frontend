...
//       link: "/soil-health" 
//     },
//     { title: "Irrigation Scheduler", desc: "Plan watering based on weather forecasts and crop water needs to save resources.", icon: <WaterIcon />, link: "/irrigation" },
//     { title: "Pest & Disease Alerts", desc: "Get real-time notifications and prevention tips for pest and disease risks.", icon: <BugReportIcon />, link: "/pest-alerts" },
//     { title: "Yield Forecasting", desc: "Predict crop yields using data to plan resources and maximize profits.", icon: <TrendingUpIcon />, link: "/yield-forecast" },
//   ];
//   return (
