...
//   const handleLogout = () => {
//     axios
//       .post("https://agrihub-backend-tz4v.onrender.com/api/users/logout", {}, { withCredentials: true })
//       .then(() => {
...
import AssignmentTurnedInIcon from "@mui/icons-material/AssignmentTurnedIn";
  ...
  const Sidebar = ({ darkMode, toggleDarkMode, onToggleSidebar, isMobile, open, setOpen }) => {
    ...
    const menuItems = [
      ...
      { text: "Customer Orders", icon: <ReceiptIcon />, path: "/customer-order" },
      { text: "Offline Purchase", icon: <StoreIcon />, path: "/offline-order" },
      { text: "Services", icon: <BuildIcon />, path: "/manage-service" }, // Added Services route
...
// import Brightness7Icon from "@mui/icons-material/Brightness7";
// import BuildIcon from "@mui/icons-material/Build"; // Icon for Services
// import AssignmentTurnedInIcon from "@mui/icons-material/AssignmentTurnedIn"; // Icon for Service Bookings
// import "./styles/Sidebar.css";

// // Define color variables for light and dark modes
// const LIGHT_BG_GRADIENT_START = "#F5F5F5"; // Light mode background gradient start
// const LIGHT_BG_GRADIENT_END = "#E0E0E0";   // Light mode background gradient end
// const LIGHT_HEADER = "#4CAF50";            // Light mode header background
// const LIGHT_TEXT = "#212121";              // Light mode default text
// const LIGHT_TEXT_SECONDARY = "#757575";    // Light mode secondary text (e.g., email)
// const LIGHT_ACTIVE_BG = "#A5D6A7";         // Light mode active/hover background
// const LIGHT_ACTIVE_TEXT = "#388E3C";       // Light mode active text and icons

// const DARK_BG_GRADIENT_START = "#1A3C34";  // Dark mode background gradient start
// const DARK_BG_GRADIENT_END = "#14342B";    // Dark mode background gradient end
// const DARK_HEADER = "#388E3C";             // Dark mode header background
// const DARK_TEXT = "#E0E0E0";               // Dark mode default text
// const DARK_TEXT_SECONDARY = "#B0B0B0";     // Dark mode secondary text (e.g., email)
// const DARK_ACTIVE_BG = "#2E7D32";          // Dark mode active/hover background
// const DARK_ACTIVE_TEXT = "#81C784";        // Dark mode active text and icons
// const DARK_ICON_DEFAULT = "#66BB6A";       // Dark mode default icon color
// const DARK_ICON_LOGOUT = "#E94560";        // Dark mode logout icon color (red accent)

// const Sidebar = ({ darkMode, toggleDarkMode, isMobile, open, setOpen }) => {
//   const [user, setUser] = useState(null);
//   const navigate = useNavigate();
//   const location = useLocation();
...
//   // Define sidebar menu items with paths and icons
//   const menuItems = [
//     { text: "Dashboard", icon: <DashboardIcon />, path: "/admin-dashboard" },
//     { text: "Manage Vendors", icon: <StorefrontIcon />, path: "/manage-vendors" },
//     { text: "Manage Products", icon: <ShoppingCartIcon />, path: "/manage-products" },
...
//     { text: "Offline Purchase", icon: <StoreIcon />, path: "/offline-order" },
//     { text: "Services", icon: <BuildIcon />, path: "/manage-service" }, // Added Services route
//     { text: "Service Bookings", icon: <AssignmentTurnedInIcon />, path: "/admin-service-bookings" }, // Added Service Bookings route
//   ];
...
//           background: darkMode
//             ? `linear-gradient(180deg, ${DARK_BG_GRADIENT_START} 0%, ${DARK_BG_GRADIENT_END} 100%)`
//             : `linear-gradient(180deg, ${LIGHT_BG_GRADIENT_START} 0%, ${LIGHT_BG_GRADIENT_END} 100%)`,
...
//           justifyContent: open ? "space-between" : "center",
//           padding: "12px 16px",
//           backgroundColor: darkMode ? DARK_HEADER : LIGHT_HEADER, // Header color based on mode
//         }}
//       >
//         {open && (
//           <Typography variant="h6" sx={{ fontWeight: "bold", color: "#FFF", letterSpacing: "1px" }}>
...
//       {open && user && (
//         <Box sx={{ padding: "16px", textAlign: "center", bgcolor: darkMode ? DARK_BG_GRADIENT_END : LIGHT_BG_GRADIENT_END }}>
//           <Avatar
//             sx={{
//               bgcolor: "#66BB6A", // Medium green avatar
//               margin: "0 auto",
//               width: 50,
//               height: 50,
//               border: `2px solid ${darkMode ? DARK_ACTIVE_TEXT : LIGHT_ACTIVE_TEXT}`, // Active green border
//             }}
//           >
//             {user.username?.charAt(0) || "U"}
//           </Avatar>
//           <Typography variant="body1" sx={{ mt: 1, color: darkMode ? DARK_TEXT : LIGHT_TEXT, fontWeight: "medium" }}>
//             {user.username || "Admin"}
//           </Typography>
//           <Typography variant="caption" sx={{ color: darkMode ? DARK_TEXT_SECONDARY : LIGHT_TEXT_SECONDARY }}>
//             {user.email || "admin@agrihub.com"}
//           </Typography>
//         </Box>
//       )}
...
//               justifyContent: open ? "initial" : "center",
//               px: 2.5,
//               bgcolor: location.pathname === item.path ? (darkMode ? DARK_ACTIVE_BG : LIGHT_ACTIVE_BG) : "transparent",
//               "&:hover": {
//                 bgcolor: darkMode ? DARK_ACTIVE_BG : LIGHT_ACTIVE_BG, // Hover background
//                 "& .MuiListItemIcon-root": { color: darkMode ? DARK_ACTIVE_TEXT : LIGHT_ACTIVE_TEXT }, // Hover icon color
//               },
//               transition: "background-color 0.2s ease",
//             }}
//           >
...
//                   ? (darkMode ? DARK_ACTIVE_TEXT : LIGHT_ACTIVE_TEXT) // Active icon color
//                   : darkMode ? DARK_ICON_DEFAULT : LIGHT_TEXT_SECONDARY, // Default icon color
//               }}
//             >
//               {item.icon}
//             </ListItemIcon>
...
//                 sx={{
//                   color: location.pathname === item.path
//                     ? (darkMode ? "#FFF" : LIGHT_ACTIVE_TEXT) // Active text color (white in dark mode)
//                     : darkMode ? DARK_TEXT : LIGHT_TEXT, // Default text color
//                   "& .MuiTypography-root": { fontWeight: 500 },
//                 }}
//               />
//             </Collapse>
...
//         {open && (
//           <ListItemButton onClick={toggleDarkMode} sx={{ justifyContent: "initial", px: 2.5 }}>
//             <ListItemIcon sx={{ minWidth: 40, color: darkMode ? DARK_ACTIVE_TEXT : LIGHT_TEXT_SECONDARY }}>
//               {darkMode ? <Brightness7Icon /> : <Brightness4Icon />}
//             </ListItemIcon>
//             <ListItemText
//               primary={darkMode ? "Light Mode" : "Dark Mode"}
//               sx={{ color: darkMode ? DARK_TEXT : LIGHT_TEXT, "& .MuiTypography-root": { fontWeight: 500 } }}
//             />
//           </ListItemButton>
//         )}
//         <ListItemButton
...
//           sx={{
//             justifyContent: open ? "initial" : "center",
//             "&:hover": { bgcolor: darkMode ? DARK_ACTIVE_BG : LIGHT_ACTIVE_BG },
//             transition: "background-color 0.2s ease",
//           }}
//         >
//           <ListItemIcon sx={{ minWidth: open ? 40 : 0, color: darkMode ? DARK_ICON_LOGOUT : LIGHT_TEXT_SECONDARY }}>
//             <ExitToAppIcon />
//           </ListItemIcon>
//           <Collapse in={open} orientation="horizontal">
//             <ListItemText
