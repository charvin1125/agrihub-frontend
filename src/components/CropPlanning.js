...
//   // Theme configuration (consistent with previous files)
...
//   // Seasonal recommendations (static data for demo)
//   const seasonalCrops = {
//     Spring: ["Wheat", "Barley", "Peas"],
//     Summer: ["Corn", "Rice", "Sunflowers"],
//     Fall: ["Pumpkin", "Potatoes", "Carrots"],
//     Winter: ["Kale", "Spinach", "Garlic"],
//   };
...
//     if (savedCrops) {
//       setPlannedCrops(JSON.parse(savedCrops));
//     }
//   }, []);
...
//       { id: Date.now(), ...newCrop },
//     ]);
//     setNewCrop({ name: "", season: "Spring", plantingDate: "", harvestDate: "" });
//   };
...
//   // Calculate timeline progress (for display purposes)
...
//               Plan your crops with seasonal recommendations and timelines.
//             </Typography>
//           </Container>
//         </Box>
...
//                       <TableCell>{getTimelineProgress(crop.plantingDate, crop.harvestDate)}</TableCell>
//                       <TableCell>
//                         <IconButton
...
//               {Object.entries(seasonalCrops).map(([season, crops]) => (
