...
//     try {
//       const response = await axios.get("https://agrihub-backend-xu19.onrender.com/api/vendor/list", { withCredentials: true });
...
//     try {
//       const response = await axios.get("https://agrihub-backend-xu19.onrender.com/api/users/me", { withCredentials: true });
...
//     try {
//       if (isEditing) {
//         await axios.put(`https://agrihub-backend-xu19.onrender.com/api/vendor/${editId}`, vendor, { withCredentials: true });
//         alert("Vendor updated successfully!");
//         setIsEditing(false);
//         setEditId(null);
//       } else {
//         await axios.post("https://agrihub-backend-xu19.onrender.com/api/vendor/add", vendor, { withCredentials: true });
...
//       try {
//         await axios.delete(`https://agrihub-backend-xu19.onrender.com/api/vendor/${id}`, { withCredentials: true });
...
//             <input type="text" name="name" placeholder="Company Name" value={vendor.name} onChange={handleChange} required />
...
//             <textarea name="address" placeholder="Address" value={vendor.address} onChange={handleChange}></textarea>
...
//                 {user?.isAdmin && (
//                   <td>
//                     <button onClick={() => handleEdit(v._id, v)}>Edit</button>
