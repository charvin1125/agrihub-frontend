...
const ManageVendors = () => {
  ...
  const fetchVendors = async () => {
    try {
      const response = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/vendor/list", { withCredentials: true });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`https://agrihub-backend-pvfl.onrender.com/api/vendor/${editId}`, vendor, { withCredentials: true });
        alert("Vendor updated successfully!");
        setIsEditing(false);
        setEditId(null);
      } else {
        await axios.post("https://agrihub-backend-pvfl.onrender.com/api/vendor/add", vendor, { withCredentials: true });
  ...
  const handleDelete = async (id) => {
    ...
    if (window.confirm("Are you sure you want to delete this vendor?")) {
      try {
        await axios.delete(`https://agrihub-backend-pvfl.onrender.com/api/vendor/${id}`, { withCredentials: true });
