...
const AddProduct = () => {
      ...
      const fetchData = async () => {
        try {
          const [categoryRes, brandRes, productRes] = await Promise.all([
            axios.get("https://agrihub-backend-pvfl.onrender.com/api/category/list", { withCredentials: true }),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://agrihub-backend-pvfl.onrender.com/api/product/add", formData, {
      ...
      const productRes = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/product/list", { withCredentials: true });
      setProducts(productRes.data || []);
    } catch (error) {
