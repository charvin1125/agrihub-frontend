...
const Checkout = () => {
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      try {
        const response = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/users/profile", { withCredentials: true });
  ...
  const handleOrder = async () => {
    ...
    try {
      if (paymentMethod === "Pay Later" || paymentMethod === "Cash") {
        const response = await axios.post("https://agrihub-backend-pvfl.onrender.com/api/orders/place", orderData, { withCredentials: true });
        ...
        const orderResponse = await axios.post(
          "https://agrihub-backend-pvfl.onrender.com/api/orders/create-razorpay-order",
          ...
          handler: async (response) => {
            try {
              const verifyResponse = await axios.post(
                "https://agrihub-backend-pvfl.onrender.com/api/orders/verify-razorpay-payment",
                {
