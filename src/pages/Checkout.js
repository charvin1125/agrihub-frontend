...
//   try {
//     const response = await axios.post("https://agrihub-backend-tz4v.onrender.com/api/orders/place", orderData, {
...
//     const { data: productsData } = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/product/list");
...
//       const response = await fetch("https://agrihub-backend-tz4v.onrender.com/api/orders/place", {
//         method: "POST",
//         headers: {
...
//     try {
//       const response = await fetch("https://agrihub-backend-tz4v.onrender.com/api/order/place", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//           "https://agrihub-backend-tz4v.onrender.com/api/orders/create-razorpay-order",
...
//                 "https://agrihub-backend-tz4v.onrender.com/api/orders/verify-razorpay-payment",
//                 {
