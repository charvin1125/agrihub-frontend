...
const AdminServiceBookings = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const userRes = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/users/me", { withCredentials: true });
        ...
        const [bookingsRes, laborsRes] = await Promise.all([
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/bookings/all", { withCredentials: true }),
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/labors/list", { withCredentials: true }),
        ]);
        setBookings(
  ...
  const handleApprove = async (bookingId) => {
    ...
    try {
      const response = await axios.put(
        `https://agrihub-backend-pvfl.onrender.com/api/bookings/approve/${bookingId}`,
