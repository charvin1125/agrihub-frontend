...
//       setLoading(true);
//       try {
//         const userRes = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/users/me", { withCredentials: true });
...
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/bookings/all", { withCredentials: true }),
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/labors/list", { withCredentials: true }),
//         ]);
...
//   // Handle labor assignment and date update
//   const handleApprove = async (bookingId, laborId, serviceDate) => {
//     try {
//       await axios.put(
//         `https://agrihub-backend-tz4v.onrender.com/api/bookings/approve/${bookingId}`,
//         { laborId, serviceDate },
...
//       setBookings((prev) =>
//         prev.map((b) =>
//           b._id === bookingId ? { ...b, laborId, serviceDate, status: "Approved" } : b
//         )
//       );
//     } catch (error) {
...
//                               onChange={(e) => handleApprove(booking._id, e.target.value, booking.serviceDate || new Date().toISOString().split("T")[0])}
//                               displayEmpty
...
//                             <TextField
//                               type="date"
//                               value={booking.serviceDate ? booking.serviceDate.split("T")[0] : ""}
//                               onChange={(e) => handleApprove(booking._id, booking.laborId || labors[0]?._id, e.target.value)}
//                               size={isMobile ? "small" : "medium"}
//                               sx={{ minWidth: isMobile ? 100 : 120 }}
//                             />
//                           </TableCell>
//                           <TableCell align="right">
//                             {booking.laborId && booking.serviceDate ? (
...
//                                 color="primary"
//                                 size="small"
//                                 onClick={() => handleApprove(booking._id, booking.laborId || labors[0]?._id, booking.serviceDate || new Date().toISOString().split("T")[0])}
