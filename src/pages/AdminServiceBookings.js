...
//       setLoading(true);
//       try {
//         const userRes = await axios.get("https://agrihub-backend-xu19.onrender.com/api/users/me", { withCredentials: true });
...
//           axios.get("https://agrihub-backend-xu19.onrender.com/api/bookings/all", { withCredentials: true }),
//           axios.get("https://agrihub-backend-xu19.onrender.com/api/labors/list", { withCredentials: true }),
//         ]);
...
//     try {
//       await axios.put(
//         `https://agrihub-backend-xu19.onrender.com/api/bookings/approve/${bookingId}`,
//         { laborId, serviceDate },
