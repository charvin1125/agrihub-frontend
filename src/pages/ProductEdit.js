...
const EditProduct = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const res = await axios.get(`https://agrihub-backend-pvfl.onrender.com/api/product/${id}`, { withCredentials: true });
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://agrihub-backend-pvfl.onrender.com/api/product/update/${id}`, formData, {
  ...
  const handleDelete = async () => {
    if (window.confirm("Are you sure you want to delete this product?")) {
      try {
        await axios.delete(`https://agrihub-backend-pvfl.onrender.com/api/product/delete/${id}`, { withCredentials: true });
