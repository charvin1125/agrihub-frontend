...
const AddLabor = () => {
  ...
  const fetchLabors = async () => {
    try {
      const res = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/labor/list", { withCredentials: true });
      setLabors(res.data);
    } catch (error) {
    ...
    try {
      if (editId) {
        const res = await axios.put(
          `https://agrihub-backend-pvfl.onrender.com/api/labor/edit/${editId}`,
        ...
        const res = await axios.post(
          "https://agrihub-backend-pvfl.onrender.com/api/labor/add",
          { name, mobile, availability },
          { withCredentials: true }
        );
  ...
  const handleDeleteLabor = async (id) => {
    ...
    try {
      await axios.delete(`https://agrihub-backend-pvfl.onrender.com/api/labor/delete/${id}`, { withCredentials: true });
