...
//     try {
//       const response = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/category/list", { withCredentials: true });
...
//     try {
//       if (isEditing) {
//         await axios.put(`https://agrihub-backend-tz4v.onrender.com/api/category/${editId}`, category, { withCredentials: true });
//         alert("Category updated successfully!");
//         setIsEditing(false);
//         setEditId(null);
//       } else {
//         await axios.post("https://agrihub-backend-tz4v.onrender.com/api/category/add", category, { withCredentials: true });
...
//       try {
//         await axios.delete(`https://agrihub-backend-tz4v.onrender.com/api/category/${id}`, { withCredentials: true });
...
// {!user?.isAdmin && <p style={{ color: "red" }}>You do not have permission to manage categories.</p>}
...
//                 {user?.isAdmin && (
//                   <td>
//                     <button onClick={() => handleEdit(c._id, c)}>Edit</button>
