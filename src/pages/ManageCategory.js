...
const ManageCategory = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/category/list", { withCredentials: true });
  ...
  const fetchUser = async () => {
    try {
      const response = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/users/me", { withCredentials: true });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`https://agrihub-backend-pvfl.onrender.com/api/category/${editId}`, category, { withCredentials: true });
        alert("Category updated successfully!");
        setIsEditing(false);
        setEditId(null);
      } else {
        await axios.post("https://agrihub-backend-pvfl.onrender.com/api/category/add", category, { withCredentials: true });
  ...
  const handleDelete = async (id) => {
    ...
    if (window.confirm("Are you sure you want to delete this category?")) {
      try {
        await axios.delete(`https://agrihub-backend-pvfl.onrender.com/api/category/${id}`, { withCredentials: true });
