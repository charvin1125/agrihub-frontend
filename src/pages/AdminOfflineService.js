...
const AdminOfflineService = () => {
  ...
  const fetchServices = async () => {
    ...
    try {
      ...
      const res = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/services/list", {
  ...
  const fetchCustomerDetails = async (phoneNumber) => {
    ...
    try {
      const res = await axios.get(`https://agrihub-backend-pvfl.onrender.com/api/bookings/customer/${phoneNumber}`, { withCredentials: true });
  ...
  const handleBookService = async () => {
    ...
    try {
      const bookingPromises = selectedServices.map(async (item) => {
        ...
        return axios.post("https://agrihub-backend-pvfl.onrender.com/api/book-service", bookingData, { withCredentials: true });
      });
