...
//   useEffect(() => {
//     axios.get("https://agrihub-backend-tz4v.onrender.com/api/users/profile", { withCredentials: true })
//       .then((response) => {
//         if (response.data) {
...
//     e.preventDefault();
//     try {
//       await axios.post("https://agrihub-backend-tz4v.onrender.com/api/users/login", formData, { withCredentials: true });

//       // Fetch user session to verify login
//       const response = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/users/profile", { withCredentials: true });
...
//   useEffect(() => {
//     axios
//       .get("https://agrihub-backend-tz4v.onrender.com/api/users/profile", { withCredentials: true })
//       .then((response) => {
//         if (response.data) {
//           navigate(response.data.isAdmin ? "/admin-dashboard" : "/profile");
//         }
...
//   <Button component={Link} to="/forgot-password" sx={{ color: "secondary.main", p: 0 }}>
//     Forgot Password?
//   </Button>
// </Typography>
//             </CardContent>
...
//     try {
//       const response = await axios.post("https://agrihub-backend-tz4v.onrender.com/api/users/forgot-password", forgotData);
...
// Set Axios defaults globally (do this in a setup file like index.js ideally)
...
const LoginPage = () => {
  ...
  useEffect(() => {
    axios
      .get("https://agrihub-backend-tz4v.onrender.com/api/users/profile")
      .then((response) => {
        console.log("Initial profile check:", response.data); // Debug
        if (response.data) {
          navigate(response.data.isAdmin ? "/admin-dashboard" : "/profile");
        }
      })
      .catch((error) => {
        console.error("Initial profile error:", error.response?.data || error.message); // Debug
      })
      .finally(() => setLoading(false));
  }, [navigate]);
  ...
  const handleForgotSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://agrihub-backend-tz4v.onrender.com/api/users/forgot-password",
        forgotData
      );
      ...
      console.error("Forgot password error:", error.response?.data || error.message); // Debug
      setForgotMessage(error.response?.data?.error || "Failed to reset password.");
    } finally {
      setForgotLoading(false);
    }
