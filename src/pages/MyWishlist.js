...
const MyWishlist = () => {
  ...
  useEffect(() => {
    const fetchWishlist = async () => {
        try {
          const response = await axios.get("https://agrihub-backend-xu19.onrender.com/api/users/wishlist", { withCredentials: true });
  ...
  const handleRemoveFromWishlist = async (productId) => {
    try {
      await axios.post(
        "https://agrihub-backend-xu19.onrender.com/api/users/wishlist/remove",
        { productId },
                        ...
                        <CardMedia
                          ...
                          image={
                            product.images.find((img) => img.isMain)?.url
                              ? `https://agrihub-backend-xu19.onrender.com/${product.images.find((img) => img.isMain).url}`
