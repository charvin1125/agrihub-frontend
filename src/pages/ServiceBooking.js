...
//     try {
//       const res = await axios.post("https://agrihub-backend-tz4v.onrender.com/api/services/book-service", bookingData, {
...
const ServiceBooking = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://agrihub-backend-tz4v.onrender.com/api/book-service", bookingData, {
        withCredentials: true,
      });
      alert("Service booked successfully! Booking ID: " + res.data.bookingId);
      navigate("/services");
