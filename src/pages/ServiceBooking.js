...
//   // Get service details from location state (passed from Services.js)
...
//     const bookingData = {
//       userId: user._id, // Include logged-in user's ID
...
//     try {
//       const res = await axios.post("https://agrihub-backend-xu19.onrender.com/api/services/book-service", bookingData, {
...
//   // Calculate total price based on area and price per 100 sq ft
...
//     try {
//       const res = await axios.post("https://agrihub-backend-xu19.onrender.com/api/book-service", bookingData, {
//         withCredentials: true,
//       });
//       alert("Service booked successfully! Booking ID: " + res.data.bookingId);
//       navigate("/services");
//     } catch (error) {
//       console.error("Booking Error:", error.response?.data || error.message); // Log detailed error
