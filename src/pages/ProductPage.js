    ...
    const fetchData = async () => {
      try {
        const [productRes, categoryRes, brandRes] = await Promise.all([
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/product/list"),
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/category/list"),
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/vendor/list"),
        ]);
                    ...
                    <Grid item xs={12} sm={6} md={4} key={product._id}>
                      <Card>
                        <CardMedia
                          ...
                          image={
                            product.mainImage
                              ? `https://agrihub-backend-pvfl.onrender.com/${product.mainImage}`
