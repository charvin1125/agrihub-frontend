...
//                             <TableCell>
//                               <img
//                                 src={`https://agrihub-backend-xu19.onrender.com/${product.image}`}
//                                 alt={product.name}
//                                 style={{
...
//       // If backend already populates category and brand names
//       const updatedProducts = productRes.data.map((product) => ({
//         ...product,
...
//       // If population isn't working, fetch separately (uncomment if needed)
//       /*
...
//     setProducts((prev) =>
//       [...prev].sort((a, b) => {
//         if (field === "batchNumber" || field === "name" || field === "categoryName" || field === "brandName") {
...
//                         Brand {sortField === "brandName" && (sortOrder === "asc" ? "↑" : "↓")}
//                       </TableCell>
//                       <TableCell onClick={() => handleSort("batchNumber")} sx={{ cursor: "pointer", display: { xs: "none", md: "table-cell" } }}>
//                         Batch Number {sortField === "batchNumber" && (sortOrder === "asc" ? "↑" : "↓")}
//                       </TableCell>
//                       <TableCell align="right">Actions</TableCell>
//                     </TableRow>
//                   </TableHead>
...
//                               {product.mainImage ? (
//                                 <img
//                                   src={`https://agrihub-backend-xu19.onrender.com/${product.mainImage}`}
//                                   alt={product.name}
//                                   style={{
//                                     height: isMobile ? 40 : 50,
//                                     width: isMobile ? 40 : 50,
...
//                     ) : (
//                       <TableRow>
//                         <TableCell colSpan={6} align="center" sx={{ color: "text.primary" }}>
//                           No products found
//                         </TableCell>
//                       </TableRow>
//                     )}
...
//       const updatedProducts = productRes.data.map((product) => {
//         // Calculate total stock and find oldest batch with stock
//         const totalStock = product.variants.reduce((sum, variant) =>
//           sum + variant.batches.reduce((batchSum, batch) => batchSum + (batch.stock || 0), 0), 0);
