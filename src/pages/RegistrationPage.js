...
//     try {
//       const response = await axios.post("https://agrihub-backend-pvfl.onrender.com/api/users/register", formData);
...
const RegistrationPage = () => {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      await axios.post("https://agrihub-backend-pvfl.onrender.com/api/users/register", {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      await axios.post("https://agrihub-backend-pvfl.onrender.com/api/users/verify-register-otp", {
        mobile: formData.mobile,
        otp: formData.otp,
      });
