                ...
                {products.length > 0 ? (
                    products.map((product) => (
                        <div key={product._id} className="product-card">
                            <img
                                src={`https://agrihub-backend-tz4v.onrender.com/uploads/${product.image}`} // Fetch image dynamically
                                alt={product.name}
            ...
            {selectedProduct && (
                <div className="product-modal">
                    <div className="modal-content">
                        ...
                        <img src={`https://agrihub-backend-tz4v.onrender.com/uploads/${selectedProduct.image}`} alt={selectedProduct.name} />
