...
const ShopPage = () => {
    ...
    const fetchProducts = async () => {
        try {
            const response = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/product/list");
                ...
                {products.length > 0 ? (
                    products.map((product) => (
                        <div key={product._id} className="product-card">
                            <img
                                src={`https://agrihub-backend-pvfl.onrender.com/uploads/${product.image}`} // Fetch image dynamically
                                alt={product.name}
            ...
            {selectedProduct && (
                <div className="product-modal">
                    <div className="modal-content">
                        ...
                        <img src={`https://agrihub-backend-pvfl.onrender.com/uploads/${selectedProduct.image}`} alt={selectedProduct.name} />
