...
//   const handleLogout = () => {
//     axios.post("https://agrihub-backend-tz4v.onrender.com/api/users/logout", {}, { withCredentials: true })
//       .then(() => {
//         localStorage.removeItem("user");
//         navigate("/login");
//       })
...
//     try {
//       const response = await axios.put("https://agrihub-backend-tz4v.onrender.com/api/users/update", formData, {
...
const ProfilePage = () => {
  ...
  const handlePasswordSave = async () => {
    ...
    try {
      await axios.put(
        "https://agrihub-backend-tz4v.onrender.com/api/users/change-password",
        {
