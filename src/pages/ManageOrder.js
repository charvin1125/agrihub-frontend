...
//       try {
//         const res = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/orders/all-orders", { withCredentials: true });
//         setOrders(res.data);
//       } catch (error) {
...
//     try {
//       await axios.put(`https://agrihub-backend-tz4v.onrender.com/api/orders/${orderId}`, { status }, { withCredentials: true });
...
const ManageOrders = () => {
  ...
  const fetchOrders = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/orders/list");
      setOrders(res.data || []);
    } catch (error) {
      console.error("Error fetching orders:", error);
    }
  ...
  const handleUpdateStatus = async () => {
    try {
      await axios.put(`https://agrihub-backend-tz4v.onrender.com/api/orders/update/${selectedOrder._id}`, {
