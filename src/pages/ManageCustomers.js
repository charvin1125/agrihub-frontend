...
const ManageCustomers = () => {
  ...
  const fetchCustomers = async () => {
    try {
      const response = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/users/customers", {
  ...
  const handleDelete = async (customerId) => {
    if (window.confirm("Are you sure you want to delete this customer?")) {
      try {
        ...
        await axios.delete(`https://agrihub-backend-pvfl.onrender.com/api/users/${customerId}`, {
