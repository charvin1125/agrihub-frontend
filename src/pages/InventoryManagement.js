...
//     try {
//       await axios.put(
//         `https://agrihub-backend-xu19.onrender.com/api/products/${editProduct._id}/update-stock`,
//         {
...
//       await axios.put(
//         `https://agrihub-backend-xu19.onrender.com/api/products/${editProduct._id}/update-stock`,
//         { variantId: editVariant._id, stock: editStock },
//         { withCredentials: true }
//       );
//       setEditProduct(null);
//       setEditVariant(null);
...
//       product.variants.map((v) => `${v.size}: ${v.stock || 0}`).join(", "),
//       product.variants.reduce((sum, v) => sum + (v.stock || 0), 0),
//     ]);

//     doc.autoTable({
//       startY: 40,
//       head: [["Product Name", "Category", "Brand", "Variants (Size: Stock)", "Total Stock"]],
//       body: tableData,
//       theme: "grid",
...
//                                     <TableCell align="right">
//                                       <Chip
//                                         label={`${variant.stock || 0} in stock`}
//                                         color={variant.stock <= 5 ? "error" : "success"}
//                                         size={isMobile ? "small" : "medium"}
//                                       />
//                                     </TableCell>
...
//                   </Typography>
//                   <Typography variant="body1" sx={{ mb: 2, color: "text.primary" }}>
//                     Product: <b>{editProduct.name || "N/A"}</b> ({editVariant.size || "N/A"})
//                   </Typography>
//                   <TextField
//                     fullWidth
//                     type="number"
