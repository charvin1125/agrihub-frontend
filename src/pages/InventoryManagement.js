...
//     try {
//       await axios.put(`https://agrihub-backend-tz4v.onrender.com/api/products/${selectedProduct._id}/update-stock`, {
...
//     try {
//       await axios.put(
//         `https://agrihub-backend-tz4v.onrender.com/api/products/${editProduct._id}/update-stock`,
//         {
