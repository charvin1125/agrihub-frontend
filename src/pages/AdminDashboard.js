...
//   // Static data for latest 5 product reviews with avatars
//   const latestReviews = [
...
//           axios.get("https://agrihub-backend-xu19.onrender.com/api/dashboard/total-users", { withCredentials: true }),
//           axios.get("https://agrihub-backend-xu19.onrender.com/api/dashboard/total-revenue", { withCredentials: true }),
//           axios.get("https://agrihub-backend-xu19.onrender.com/api/dashboard/total-orders", { withCredentials: true }),
//         ]);
...
//       try {
//         const res = await axios.get("https://agrihub-backend-xu19.onrender.com/api/product/low-stock", { withCredentials: true });
...
//   // Fetch stock by brand data with gradient
//   useEffect(() => {
//     const fetchStockByBrand = async () => {
//       try {
//         setLoadingStock(true);
//         const stockRes = await axios.get("https://agrihub-backend-xu19.onrender.com/api/product/stock-by-brand", { withCredentials: true });
//         const labels = stockRes.data.data.map((item) => item.brand || "Unknown");
//         const data = stockRes.data.data.map((item) => item.totalStock);
...
//         setStockByBrandData({
//           labels,
//           datasets: [{ data, backgroundColor: gradientColors, borderWidth: 2, borderColor: "#fff" }],
//         });
//       } catch (error) {
...
//   // Fetch order stats with gradient
//   useEffect(() => {
//     const fetchOrderStats = async () => {
//       try {
//         const res = await axios.get("https://agrihub-backend-xu19.onrender.com/api/orders/stats", { withCredentials: true });
...
//   // Fetch sales distribution with gradient
//   useEffect(() => {
//     const fetchSalesDistribution = async () => {
//       try {
//         const res = await axios.get("https://agrihub-backend-xu19.onrender.com/api/orders/sales", { withCredentials: true });
//         const data = [
...
//               <IconButton
//                 color="inherit"
//                 onClick={(e) => setShowLowStockCard(!showLowStockCard)}
...
//                 <Card>
//                   <CardContent>
//                     <LowStockNotification darkMode={darkMode} />
//                   </CardContent>
//                 </Card>
//               </Grid>
//             </Grid>
...
//   // Updated Stock by Brand Fetch
//   useEffect(() => {
//     const fetchStockByBrand = async () => {
//       try {
//         setLoadingStock(true);
        
//         // Fetch stock by brand and brand list
//         const [stockRes, brandRes] = await Promise.all([
//           axios.get("https://agrihub-backend-xu19.onrender.com/api/product/stock-by-brand", { withCredentials: true }),
//           axios.get("https://agrihub-backend-xu19.onrender.com/api/vendor/list", { withCredentials: true }),
//         ]);

//         console.log("Stock by Brand Response:", stockRes.data);
...
//         // Process stock data
//         const labels = stockRes.data.data.map((item) => {
//           const brandId = typeof item.brand === "object" && item.brand?._id ? item.brand._id : item.brand;
//           return brandMap[brandId] || "Unknown Brand";
//         });
//         const data = stockRes.data.data.map((item) => item.totalStock || 0);
