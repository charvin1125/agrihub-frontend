...
//       try {
//         const res = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/product/low-stock", { withCredentials: true });
...
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/dashboard/stats"),
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/dashboard/brand-stock"),
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/dashboard/order-stats"),
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/dashboard/sales-trends"),
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/dashboard/top-products"),
//         ]);
...
//       try {
//         const res = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/orders/stats", { withCredentials: true });
...
//       try {
//         const res = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/orders/sales", { withCredentials: true });
...
//       try {
//         const res = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/product/stock-by-vendor", {
...
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/dashboard/total-users", { withCredentials: true }),
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/dashboard/total-revenue", { withCredentials: true }),
//           axios.get("https://agrihub-backend-tz4v.onrender.com/api/dashboard/total-orders", { withCredentials: true }),
//         ]);
...
//     const fetchStockData = async () => {
//       try {
//         const res = await axios.get("https://agrihub-backend-tz4v.onrender.com/api/product/stock-by-vendor", { withCredentials: true });
//         const labels = res.data.map((vendor) => vendor.vendorName);
//         const data = res.data.map((vendor) => vendor.totalStock);
...
const AdminDashboard = () => {
  ...
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [isMobile, setIsMobile] = useState(window.innerWidth < 600);
  const [showLowStockCard, setShowLowStockCard] = useState(false); // Toggle for card visibility
  const navigate = useNavigate();
          ...
          >
            ...
            <Box>
              <Tooltip title="Low Stock Alerts">
                <IconButton
                  color="inherit"
                  onClick={(e) => setShowLowStockCard(!showLowStockCard)} // Toggle card visibility
