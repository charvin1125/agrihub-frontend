...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const res = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/users/me", { withCredentials: true });
    ...
    const fetchDashboardStats = async () => {
      try {
        const [usersRes, revenueRes, ordersRes] = await Promise.all([
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/dashboard/total-users", { withCredentials: true }),
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/dashboard/total-revenue", { withCredentials: true }),
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/dashboard/total-orders", { withCredentials: true }),
        ]);
    ...
    const fetchStockByBrand = async () => {
      try {
        ...
        const [productRes, brandRes] = await Promise.all([
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/product/list", { withCredentials: true }),
          axios.get("https://agrihub-backend-pvfl.onrender.com/api/vendor/list", { withCredentials: true }),
        ]);
  ...
  useEffect(() => {
    const fetchOrderStats = async () => {
      try {
        const res = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/orders/stats", { withCredentials: true });
  ...
  useEffect(() => {
    const fetchSalesDistribution = async () => {
      try {
        const res = await axios.get("https://agrihub-backend-pvfl.onrender.com/api/orders/sales", { withCredentials: true });
        const data = [
